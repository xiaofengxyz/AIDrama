...
4. [AI 漫剧赚钱方式与落地路线](ai-drama-business-plan.md)：内容试制、B2B、账号矩阵与 90 天路线。
5. [任务进度索引](task-progress.md)：跨会话交接时先看这里。
6. [AI 协作指南](../agent.md)：给后续 AI 会话使用的仓库工作规则。

## 当前推荐

主基座：`LumenX Studio`

官方上游本地参考克隆：`external/lumenx`
