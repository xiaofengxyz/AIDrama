...
- `src/film_engine/` 提供工业化 Film Core 最小闭环：Runtime、Director DSL、Shot Graph、Prompt Compiler、Registry、QA、Retry、Film State、Generation Ledger、Batch Production Runner
